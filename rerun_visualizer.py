...
class RerunVisualizer:
    ...
    def _log_depth_map(self, frame_idx: int):
        ...
        if max_depth > min_depth:
            ...
            rr.log(f"world/depth/frame_{frame_idx}", rr.Image(
                depth_rgb,
                name=f"Depth Frame {frame_idx}"
            ))
    ...
    def _log_video_frame(self, frame_idx: int):
        ...
        # Log video frame
        rr.log(f"world/video/frame_{frame_idx}", rr.Image(
            frame,
            name=f"RGB Frame {frame_idx}"
        ))
